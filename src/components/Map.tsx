                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '6rem', padding: '3rem 4rem', background: '#000', borderRadius: '32px', gap: '2rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', flexShrink: 0 }}>
                            <motion.button
                                ...
                                whileTap={{ scale: 0.97 }}
                                style={{ background: '#D4FF00', color: '#000', padding: '1.2rem 2.8rem', borderRadius: '100px', fontWeight: 900, fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: 3, border: 'none', cursor: 'pointer' }}
                            >
                                Start Building
                            </motion.button>
                            <motion.button
