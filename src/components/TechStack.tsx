...
const techs = [
    ...
    { name: "ERC-721", type: "Asset NFT Standard", color: "#D4FF00" },
        ...
        <section className="section-spacing" style={{ background: '#050505', overflow: 'hidden' }}>
            <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
                    ...
                    >
                        <h2 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 900 }}>Powered by <span style={{ color: '#D4FF00' }}>Web3 Infrastructure</span></h2>
                ...
                <div style={{ marginTop: '8rem', position: 'relative', height: '300px' }}>
                    <svg width="100%" height="100%" viewBox="0 0 1200 300">
                        ...
                        />
                        <motion.circle cx="300" cy="90" r="4" fill="#D4FF00" animate={{ r: [4, 6, 4] }} transition={{ repeat: Infinity, duration: 2 }} />
