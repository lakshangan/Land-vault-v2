        ...
        <section className="section-spacing">
            <div className="container">
                <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
                    ...
                    >
                        <h2 style={{ fontSize: '3rem', fontWeight: 900 }}>The <span style={{ color: '#D4FF00' }}>Architects</span></h2>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem' }}>
                    {team.map((member, i) => (
                        ...
                        >
                            ...
                            <p style={{ color: '#D4FF00', fontSize: '0.85rem', marginBottom: '0.5rem', fontWeight: 600 }}>{member.role}</p>
            ...
            <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                ...
                >
                    <h2 style={{ fontSize: 'clamp(3rem, 7vw, 6rem)', lineHeight: 1.1, marginBottom: '2.5rem', fontWeight: 900 }}>
                        The Future of Real-World <br /> Assets is <span style={{ color: '#D4FF00' }}>On-Chain</span>
                    </h2>
